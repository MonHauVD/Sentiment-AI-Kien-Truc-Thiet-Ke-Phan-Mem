...
SECRET_KEY = 'django-insecure-*8*t5f*2*1sl5f8$$e8^qi+*@!k$*v8n3a9tcp#a0#_uuatv6v'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'review_db',  # Tên database của bạn
        'USER': 'root',        # Tên user MySQL
        'PASSWORD': '12345678',  # Mật khẩu MySQL
        'HOST': 'localhost',   # Nếu chạy local, dùng 'localhost'
